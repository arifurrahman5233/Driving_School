        ...
        <div className="container my-3 p-3 rounded shadow">
            <div class="col">
                    <div className="card h-100">
                        ...
                        <div className="text-start p-3 card-body bg-transparent">
                            ...
                            {/* <h5 className="card-title"><span className="fw-bold">Trainer License:</span> {license}</h5> */}
                        ...
                        <div className="d-flex justify-content-end">
                            <button className="btn btn-dark fw-bold">Registration</button>
                        </div>
                    </div>
                    </div>
                </div>
